---
title: Groups
description: Organize systems, containers, and components into deployment units, packages, or logical groupings.
---

Groups let you bundle related nodes together — containers that deploy as a single unit, components that belong to the same package, external systems that form an integration cluster, or any logical grouping that makes sense for your project.
...
- Groups live at one level of the hierarchy — system, container, or component groups, each bundling nodes at that level
