...
When an AI agent calls `get_task` and multiple containers are ready to work on, the task system presents a choice menu grouped by deployment groups. Scaffold tasks fire first for the group, then individual container tasks follow.
