...
- **Status tracking** — three statuses: <span class="status-pill status-proposed">Proposed</span> <span class="status-pill status-wip">WIP</span> <span class="status-pill status-ready">Ready</span>
