...
2. **Connect your AI tool** — Claude Code, Codex, Cursor, or any MCP-compatible agent
...
- **Fill with AI** — let an agent scan your codebase and populate empty systems or containers
...
- Set up [AI tool integration](/scryer/getting-started/connecting-ai/) with Claude Code, Codex, or Cursor
