...
import type { Status, Hint } from "../types";
...
type ProcessNodeType = Node<ProcessNodeData>;

export function ProcessNode({ id, data, selected }: NodeProps<ProcessNodeType>) {
  ...
  return (
    <div
      className={`relative rounded-lg border border-dashed min-w-[260px] max-w-[360px] ${
        selected
